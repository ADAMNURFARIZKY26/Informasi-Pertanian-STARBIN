            ...
            <ul
                ...
                <li class="nav-item">
                    <form method="POST" action="{{ route('logout') }}" id="logout-form">
                        @csrf
                        <button type="submit" class="nav-link btn btn-link" style="text-decoration: none; color: white; padding: 0; border: none; background: none;">
                            <i class="bi bi-box-arrow-right"></i> <!-- Icon sesuai -->
                            <p>Logout</p>
                        </button>
                    </form>
                </li>
