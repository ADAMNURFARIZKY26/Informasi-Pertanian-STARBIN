...
<head>
    ...
    <link
        rel="stylesheet"
        href="{{asset('dashboard-admin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}" />
    <!-- iCheck -->
    <link
        rel="stylesheet"
        href="{{asset('dashboard-admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}" />
    <!-- JQVMap -->
    ...
    <div class="wrapper">
        ...
        <div
            ...
            <img
                ...
                src="{{asset('dashboard-admin/dist/img/AdminLTELogo.png')}}"
                alt="AdminLTELogo"
                height="60"
                width="60" />
        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img
                                    src="{{asset('dashboard-admin/dist/img/user1-128x128.jpg')}}"
                                    alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img
                                    src="{{asset('dashboard-admin/dist/img/user8-128x128.jpg')}}"
                                    alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img
                                    src="{{asset('dashboard-admin/dist/img/user3-128x128.jpg')}}"
                                    alt="User Avatar"
                                    class="img-size-50 img-circle mr-3" />
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img
                            src="{{asset('dashboard-admin/dist/img/user2-160x160.jpg')}}"
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="text-decoration: none; color: inherit;">
                                        ...
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="{{asset('dashboard-admin/dist/img/user7-128x128.jpg')}}"
                                                        alt="User Avatar" />
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="{{asset('dashboard-admin/dist/img/user5-128x128.jpg')}}"
                                                        alt="User Avatar" />
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="{{asset('dashboard-admin/dist/img/user6-128x128.jpg')}}"
                                                        alt="User Avatar" />
