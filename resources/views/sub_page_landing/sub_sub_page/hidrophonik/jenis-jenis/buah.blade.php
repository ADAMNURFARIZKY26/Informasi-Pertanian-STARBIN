...
@section('title', 'Buah skala kecil')
@section('content')
<section class="py-5">
  <div class="container">
    <br><br><br>
    <h1 class="text-center mb-5 fw-bold main-title" style="color: #008467; font-size: 2rem;">
      Detail Buah-Buahan (Skala Kecil atau Eksperimental)
    </h1>
    ...
    <article class="vegetable-item d-flex flex-column flex-md-row align-items-start mb-5 py-4 px-3 border-bottom">
      ...
      <div>
        <h4 class="veg-title mb-3"><i class="bi bi-emoji-nature me-2 text-success"></i>Apel</h4>
        <p class="veg-desc mb-3">
          Apel mengandung serat tinggi, vitamin C, dan antioksidan. Baik untuk kesehatan jantung dan membantu sistem kekebalan tubuh tanpa bahan kimia.
        </p>
      </div>
    </article>
    ...
    <article class="vegetable-item d-flex flex-column flex-md-row align-items-start mb-5 py-4 px-3 border-bottom">
      ...
      <div>
        <h4 class="veg-title mb-3"><i class="bi bi-emoji-nature me-2 text-success"></i>Pisang</h4>
        <p class="veg-desc mb-3">
          Pisang kaya potasium dan vitamin B6. Memberi energi cepat, baik untuk pencernaan, dan cocok sebagai camilan sehat tanpa residu pestisida.
        </p>
      </div>
    </article>
    ...
    <article class="vegetable-item d-flex flex-column flex-md-row align-items-start mb-5 py-4 px-3 border-bottom">
      ...
      <div>
        <h4 class="veg-title mb-3"><i class="bi bi-emoji-nature me-2 text-success"></i>Melon</h4>
        <p class="veg-desc mb-3">
          Melon memiliki kandungan air yang tinggi dan rasa manis alami. Meski menantang, melon dapat ditanam secara hidroponik dalam skala terbatas menggunakan sistem substrat.
        </p>
      </div>
    </article>
